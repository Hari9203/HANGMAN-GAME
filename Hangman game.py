...
print("Welcome " + name + "! Good Luck Buddy...")
time.sleep(2)
print("Test begins now...\n")
print("Your question will be  based on the programming languages")
print("\nDifficulty level : Hard........! No Hints will be Given")
time.sleep(2)
...
def main():
    ...
    global length
    global play_again
    secret_word = ["python", "java", "sql", "programming", "javascript","algorithm","flowchart","application","analog","computer"]
